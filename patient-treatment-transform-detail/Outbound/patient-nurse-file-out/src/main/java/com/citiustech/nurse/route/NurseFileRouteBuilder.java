...
public class NurseFileRouteBuilder extends RouteBuilder {
...
//		from("file:src/main/resources/data/in?noop=true")
				...
				.log(LoggingLevel.INFO, "Json object marshaled into xml : ${body}")
				.convertBodyTo(String.class)
				.transform(simple("${body.replace('LinkedHashMap', 'NurseDetail')}"))
				.log(LoggingLevel.INFO, "Replaced header to Nurse Detail : ${body}")
				.choice()
